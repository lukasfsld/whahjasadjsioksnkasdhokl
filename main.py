        ...
        if analyze_btn and gemini_key:
            with st.spinner("🔍 Gemini Pro analysiert alle Model-Referenzbilder (das dauert ca. 15-30 Sek.)..."):
                ...
                analysis_prompt = (
                    ...
                    "============================\n\n"
                    "SECTION 1 — CRANIAL & FACIAL STRUCTURE\n"
                    "Gender: [male/female]\n"
                    "Apparent age: [specific number]\n"
                    "Complexion: [detailed description of skin tone, undertones, finish]\n"
                    "Cranial shape: [round/oval/square/heart/diamond/oblong, proportional ratio length:width]\n"
                    "Frontal bone: [forehead height, width, slope, hairline type]\n"
                    "Supraorbital ridge: [brow shape, thickness, color, arch geometry, grooming]\n"
                    "Orbital region: [iris color with detail, eye shape, size, canthal tilt, spacing, lash density]\n"
                    "Nasal structure: [dorsum profile, bridge width, alar width, tip morphology, length ratio to face]\n"
                    "Oral region: [lip morphology, vermillion height upper/lower, cupid bow definition, width, color]\n"
                    "Mandible: [jawline definition, angle, width, gonial angle]\n"
                    "Mentum: [chin shape, projection, width, cleft presence]\n"
                    "Zygomatic arch: [cheekbone height, prominence, width]\n"
                    "Auricular: [ear size, protrusion, lobe attachment]\n"
                    "Cervical column: [neck length, circumference proportion]\n\n"
                    "SECTION 2 — HAIR SPECIFICATIONS\n"
                    "Pigmentation: [exact shade with highlight/lowlight description]\n"
                    "Length measurement: [estimated in cm from crown]\n"
                    "Fiber type: [straight/wavy/curly/coily, strand diameter fine/medium/coarse]\n"
                    "Density: [thin/normal/thick/very dense]\n"
                    "Styling: [part line, layering, fringe, current arrangement]\n"
                    "Anterior hairline: [shape, position]\n\n"
                    "SECTION 3 — SOMATOTYPE & PROPORTIONS\n"
                    "Stature estimate: [height in cm]\n"
                    "Somatotype classification: [ectomorph/mesomorph/endomorph/combination]\n"
                    "Mass estimate: [weight range in kg]\n"
                    "Thoracic measurement: [frame size and approximate circumference in cm]\n"
                    "Abdominal measurement: [waist classification and approximate circumference in cm]\n"
                    "Pelvic measurement: [hip classification and approximate circumference in cm]\n"
                    "Thorax-pelvis ratio: [numeric ratio]\n"
                    "Abdominal wall: [muscle tone description]\n"
                    "Deltoid breadth: [shoulder width classification, approximate in cm]\n"
                    "Upper arm: [muscle tone, approximate circumference]\n"
                    "Lower extremities: [muscle tone, length proportion to torso, thigh proportion]\n"
                    "Dorsal: [back width, musculature]\n"
                    "Postural alignment: [spinal alignment description]\n"
                    "Adipose distribution: [estimated body composition percentage, distribution pattern]\n\n"
                    "SECTION 4 — INTEGUMENTARY DETAILS\n"
                    "Texture mapping: [skin surface quality, pore visibility]\n"
                    "Pigmentation markers: [location and description of all freckles, nevi, beauty marks with anatomical positions]\n"
                    "Color variance: [regional skin tone differences]\n\n"
                    "SECTION 5 — EXTREMITY DETAILS\n"
                    "Manual proportions: [hand size relative to frame]\n"
                    "Digit morphology: [finger length, width]\n"
                    "Nail presentation: [shape, length, finish]\n\n"
                    "SECTION 6 — IDENTIFYING CHARACTERISTICS\n"
                    "Distinguishing markers: [all unique features with anatomical locations — dimples, dental spacing, asymmetries, modifications]\n"
                    "Overall character impression: [one sentence summary of physical presence]\n"
                )
